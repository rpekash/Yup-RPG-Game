...
public class Arrow7Script extends Script {
	 protected void setup() {
            ...
            Point loc = map.getMapTile(12,1).getLocation();
            MapTile mapTiles = new MapTileBuilder(frame)
                    .build(loc.x, loc.y);
            setMapTile(12, 1, mapTiles);
	 ...
	 @Override
	    protected void cleanup() {
         ...
         Frame arrow2Frame = new FrameBuilder(map.getTileset().getSubImage(12, 2), 0)
                 .withScale(map.getTileset().getTileScale())
                 .build();
         Point loc1 = map.getMapTile(13, 1).getLocation();
         MapTile mapTiles1 = new MapTileBuilder(arrow2Frame)
                 .withTileType(TileType.PASSABLE)
                 .build(loc1.x, loc1.y);
         setMapTile(13, 1, mapTiles1);
