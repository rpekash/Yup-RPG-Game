...
public class WinningScreen extends Screen {
	 protected static ScreenCoordinator screenCoordinator;
	    ...
	    public WinningScreen(ScreenCoordinator screenCoordinator) {
	        this.screenCoordinator = screenCoordinator;
	    }

	    public void initialize() {
	    	
		            playGame = new SpriteFont("You have completed a Puzzle! Press Space to Respawn!", 150, 150, "Comic Sans", 20, new Color(49, 207, 240));
